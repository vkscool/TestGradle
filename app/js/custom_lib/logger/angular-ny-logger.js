    ...
    this.$get = ['$log', function($log) {
        ...
        Logger.supplant = function(str, o) {
            return str.replace(
                ...
                function (a, b) {
                    var r = o[b];
                    return typeof r === 'string' || typeof r === 'number' || typeof r === 'object' ? r : a;
                }
            );
        };
        ...
        Logger.prototype = {
            _log: function(originalFn, args) {
				...
				modifiedArguments[0] = [ sprintf('%s - %s: ', now, this.context) ] + modifiedArguments[0];
				$log[originalFn].apply(null, modifiedArguments);
            },
            log: function() {
